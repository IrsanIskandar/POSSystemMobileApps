...
public static class Fas
{
    ...
    public const string PersonDressFairy = "\ue607";
    public const string PersonFairy = "\ue608";
    public const string Swap = "\ue609";
    public const string SwapArrows = "\ue60a";
    public const string AnglesUpDown = "\ue60d";
    public const string GlobePointer = "\ue60e";
    public const string Subtitles = "\ue60f";
    public const string SubtitlesSlash = "\ue610";
    public const string HeadSideGear = "\ue611";
    public const string Lighthouse = "\ue612";
    public const string Raccoon = "\ue613";
    public const string ArrowDownFromArc = "\ue614";
    public const string ArrowLeftFromArc = "\ue615";
    public const string ArrowLeftToArc = "\ue616";
    public const string ArrowUpToArc = "\ue617";
    public const string BuildingMagnifyingGlass = "\ue61c";
    public const string BuildingMemo = "\ue61e";
    public const string HammerBrush = "\ue620";
    public const string HandHoldingCircleDollar = "\ue621";
    public const string LandmarkMagnifyingGlass = "\ue622";
    public const string SignPost = "\ue624";
    public const string SignPosts = "\ue625";
    public const string SignPostsWrench = "\ue626";
    public const string TentDoublePeak = "\ue627";
    public const string TruckUtensils = "\ue628";
    public const string TRex = "\ue629";
    public const string SpinnerScale = "\ue62a";
    public const string BellRing = "\ue62c";
    public const string ArrowsRotateReverse = "\ue630";
    public const string RotateReverse = "\ue631";
    public const string ArrowTurnLeft = "\ue632";
    ...
    public const string TurnLeftDown = "\ue637";
    public const string TurnLeftUp = "\ue638";
    public const string TurnRight = "\ue639";
    public const string LocationArrowUp = "\ue63a";
    public const string TicketPerforated = "\ue63e";
    public const string TicketsPerforated = "\ue63f";
    public const string Cannon = "\ue642";
    public const string CourtSport = "\ue643";
    ...
    public const string ChartKanban = "\ue64f";
    public const string BagShoppingMinus = "\ue650";
    public const string BagShoppingPlus = "\ue651";
    public const string BasketShoppingMinus = "\ue652";
    public const string BasketShoppingPlus = "\ue653";
    public const string FileXml = "\ue654";
    public const string Bulldozer = "\ue655";
    public const string Excavator = "\ue656";
    public const string TruckLadder = "\ue657";
    public const string Tickets = "\ue658";
    public const string TicketsSimple = "\ue659";
    public const string TruckFire = "\ue65a";
    public const string Wave = "\ue65b";
    public const string WavesSine = "\ue65d";
    public const string MagnifyingGlassArrowsRotate = "\ue65e";
    public const string MagnifyingGlassMusic = "\ue65f";
    public const string MagnifyingGlassPlay = "\ue660";
    public const string MagnifyingGlassWaveform = "\ue661";
    public const string MusicMagnifyingGlass = "\ue662";
    public const string ReflectHorizontal = "\ue664";
    public const string ReflectVertical = "\ue665";
    public const string FilePng = "\ue666";
    public const string ArrowDownFromBracket = "\ue667";
    public const string ArrowLeftFromBracket = "\ue668";
    public const string ArrowLeftToBracket = "\ue669";
    public const string ArrowUpToBracket = "\ue66a";
    public const string DownFromBracket = "\ue66b";
    public const string LeftFromBracket = "\ue66c";
    public const string LeftToBracket = "\ue66d";
    public const string UpToBracket = "\ue66e";
    public const string ReflectBoth = "\ue66f";
    public const string FileCad = "\ue672";
    public const string BottleBaby = "\ue673";
    public const string TableCellsColumnLock = "\ue678";
    public const string TableCellsLock = "\ue679";
    public const string TableCellsRowLock = "\ue67a";
    public const string CircleWifi = "\ue67d";
    public const string CircleWifiCircleWifi = "\ue67e";
    public const string CircleGf = "\ue67f";
